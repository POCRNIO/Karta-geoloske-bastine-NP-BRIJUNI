...
map.getView().fit([1520579.341977, 5600115.929699, 1542636.005183, 5613303.931361], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Karta geološke baštine NP Brijuni</h2>';
        return titleElement;
    })(),
